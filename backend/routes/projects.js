...
router.post('/upload', auth, (req, res) => {
  upload.single('project')(req, res, async (err) => {
    ...
    try {
      ...
      console.log('\n🚀 Starting combined code analysis (4 analyses) in background...\n');
      const projectId = project._id;
      
      performAllAnalyses(extractedPath, project._id)
        .then(async (combinedResults) => {
          console.log('\n' + '='.repeat(80));
          console.log('🎉 ALL 4 ANALYSES COMPLETED SUCCESSFULLY');
          console.log('='.repeat(80));
          ...
          console.log(`High:                     ${combinedResults.summary.highPropDrilling}`);
          console.log(`Medium:                   ${combinedResults.summary.mediumPropDrilling}`);
          console.log(`Low:                      ${combinedResults.summary.lowPropDrilling}`);
          console.log('─'.repeat(80));
          ...
          console.log('\nSuccessfully saved all 4 analyses to database!');
          console.log(`   Project ID: ${updatedProject._id}`);
          console.log(`   Project Name: ${updatedProject.projectName}`);
          console.log('\nVIEW RESULTS AT:');
          console.log(`   GET /api/projects/${updatedProject._id}/analysis`);
          ...
          console.log(`   GET /api/projects/${updatedProject._id}/quality`);
          console.log(`   GET /api/projects/${updatedProject._id}/hooks`);
          console.log(`   GET /api/projects/${updatedProject._id}/propdrilling`);
          console.log('='.repeat(80) + '\n');
        })
        .catch(async (error) => {
          console.log('\n' + '='.repeat(80));
