...
//     // If user exists (verified or unverified), don't allow signup
//     if (existing) {
...
// // Updated login route in routes/auth.js
...
//     // Include all necessary user data including role for frontend routing
//     res.json({
//       token,
//       user: { 
//         id: user._id, 
...
//     const deletedAccount = await DeletedAccount.findOne({ email });
//     if (deletedAccount) {
...
//       verificationExpires: expiry,
//       isVerified: false,
//       createdIp: clientIp // Save IP when user signs up
//     });
...
//       remainingScans: 0 // Will be set to 20 after onboarding completion
//     });
...
//       },
//       referralApplied: !!(referralCode && validatedReferral)
//     });
...
//         // Create JWT with session ID (updated format)
//         const tokenPayload = {
//             userId: user._id,
...
//             tokenPayload,
//             process.env.JWT_SECRET,
//             { expiresIn: '7d' } // Longer expiry since we control it via sessions
//         );
...
// // Verify 2FA during login (alternative endpoint approach)
