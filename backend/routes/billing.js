...
// // POST /api/billing/purchase - Process a new purchase
...
//       paymentMethod: {
//         cardLastFour,
//         cardBrand: "Visa", // In real scenario, detect from card number
//       },
//       billingDetails: {
//         country,
//         zip,
...
//     res.status(200).json({
//       transactions: billing.transactions.sort((a, b) => b.createdAt - a.createdAt),
...
// // GET /api/billing/transaction/:transactionId - Get specific transaction
...
//     const user = await User.findById( req.user.userId );
//     user.remainingScans = Math.max(0, user.remainingScans - transaction.creditsAdded);
//     await user.save();
...
// // DELETE /api/billing/history - Clear transaction history (admin only)
...
//     // Keep the billing record but clear transactions
//     billing.transactions = [];
//     billing.totalSpent = 0;
//     billing.totalCreditsEarned = 0;
//     billing.currentPackage = {
//       packageId: "none",
//       packageName: "",
//       purchasedAt: null,
...
//     res.status(200).json({
//       success: true,
//       message: "Billing history cleared successfully",
//     });
//   } catch (error) {
//     console.error("Clear history error:", error);
//     res.status(500).json({ error: "Failed to clear billing history" });
//   }
// });
