...
//       <style>
//         /* Use similar styling to your existing email template */
//         body {
//           margin: 0;
//           padding: 0;
//           font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;
...
//       <style>
//         /* Similar styling with red theme for deletion */
//         body {
//           margin: 0;
//           padding: 0;
//           font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;
...
//             <div class="footer">
//               <p>This is an automated security notification from ${process.env.APP_NAME || 'YourApp'}.</p>
//               <p>© ${new Date().getFullYear()} ${process.env.APP_NAME || 'YourApp'}. All rights reserved.</p>
//             </div>
//           </div>
//         </body>
//         </html>
...
//               <div style="text-align: center; margin-top: 30px;">
//                 <a href="${process.env.FRONTEND_URL || 'https://yourapp.com'}/settings" class="button">
//                   Re-enable 2FA Now
//                 </a>
//               </div>
